...
MIXED_INPUT_ENABLED="${MIXED_INPUT_ENABLED:-0}"
MIXED_INPUT_TYPE_KEY="${MIXED_INPUT_TYPE_KEY:-input_type}"
MIXED_INPUT_FEATURE_LOCAL_ONLY="${MIXED_INPUT_FEATURE_LOCAL_ONLY:-1}"
...
python ./zipformer/train.py \
  ...
  --mixed-input-enabled "${MIXED_INPUT_ENABLED}" \
  --mixed-input-type-key "${MIXED_INPUT_TYPE_KEY}" \
  --mixed-input-feature-local-only "${MIXED_INPUT_FEATURE_LOCAL_ONLY}" \
