...
NODE_DATA_PRODUCER="${NODE_DATA_PRODUCER:-1}"
NODE_DATA_PRODUCER_QUEUE_SIZE="${NODE_DATA_PRODUCER_QUEUE_SIZE:-32}"
NODE_DATA_PRODUCER_NJ="${NODE_DATA_PRODUCER_NJ:-8}"
NODE_DATA_PRODUCER_MAX_AHEAD_STEPS="${NODE_DATA_PRODUCER_MAX_AHEAD_STEPS:-16}"
NODE_DATA_PRODUCER_LOG_INTERVAL="${NODE_DATA_PRODUCER_LOG_INTERVAL:-20}"
NODE_DATA_PRODUCER_METRICS_OUT="${NODE_DATA_PRODUCER_METRICS_OUT:-${EXP_DIR}/node_producer_metrics.jsonl}"
...
python ./zipformer/train.py \
  ...
  --node-data-producer-nj "${NODE_DATA_PRODUCER_NJ}" \
  --node-data-producer-max-ahead-steps "${NODE_DATA_PRODUCER_MAX_AHEAD_STEPS}" \
